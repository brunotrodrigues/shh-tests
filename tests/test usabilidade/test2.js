//DO A SIGN UP WITHOUT MATCHING PASSWORDS
...
(async function openChromeTest() {
    try {
        ...
        await birthdate_box.sendKeys('20122000');
        ...
        // password box
        await driver.sleep(500)
        await driver.findElement(By.xpath('/html/body/div/div/div/div[2]/form/div[11]/input')).sendKeys('teste');

        // confimPassword box
        await driver.sleep(500)  
        await driver.findElement(By.xpath('/html/body/div/div/div/div[2]/form/div[12]/input')).sendKeys('teste1');
